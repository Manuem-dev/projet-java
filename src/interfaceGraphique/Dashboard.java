...
public class Dashboard extends JFrame {
    ...
    public Dashboard(GestionUtilisateur gestionUtilisateur,
    ...
    private void buildUI(Utilisateur u) {
        ...
        btnRetour.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) { btnRetour.setBackground(new Color(0x283593)); }
            public void mouseExited(MouseEvent e)  { btnRetour.setBackground(ACCENT); }
        });
        ...
        btnDeconnect.addMouseListener(new MouseAdapter() {
            public void mouseEntered(MouseEvent e) { btnDeconnect.setBackground(new Color(0xB71C1C)); }
            public void mouseExited(MouseEvent e)  { btnDeconnect.setBackground(RED_CLR); }
        });
        btnDeconnect.addActionListener(e -> {
            gestionUtilisateur.deconnecter();
            new Accueil(gestionUtilisateur, gestionProduit, gestionEmploye,
    ...
    private JPanel buildMenu(Utilisateur u) {
        ...
        boolean canSeeTdb = u != null && (u.verifierRole("Directeur") || u.verifierRole("Comptable"));
        if (canSeeTdb)
            grid.add(buildCard("📊 Tableau de bord","Statistiques et rapports",    e -> { refreshDashboard(); showCard("TABLEAU_BORD"); }));
        else
            grid.add(buildCard("📊 Tableau de bord","Accès réservé",              null));

        boolean canSeeEmp = u != null && (u.verifierRole("Directeur") || u.verifierRole("Magasinier"));
        if (canSeeEmp)
