...
public class FenetreEmploye extends JPanel {
    ...
    private void buildUI() {
        ...
        table.setFont(FONT_LBL); table.setRowHeight(24);
        ...
        formPanel.setBorder(BorderFactory.createTitledBorder(
                new LineBorder(new Color(0xBDBDBD), 1, true), " Ajouter / Supprimer un employé ",
        ...
        g.gridx=0; g.gridy=0; formPanel.add(new JLabel("Matricule :"), g);
        g.gridx=1; tfMatricule = new JTextField(6); formPanel.add(tfMatricule, g);
        g.gridx=2; formPanel.add(new JLabel("Rôle :"), g);
        g.gridx=3; cbRole = new JComboBox<>(new String[]{"Caissier","ChefRayon","Directeur","Comptable","Magasinier"});
        cbRole.setFont(FONT_LBL); formPanel.add(cbRole, g);

        g.gridx=0; g.gridy=1; formPanel.add(new JLabel("Prénom :"), g);
        g.gridx=1; tfPrenom = new JTextField(12); formPanel.add(tfPrenom, g);
        g.gridx=2; formPanel.add(new JLabel("Nom :"), g);
        g.gridx=3; tfNom = new JTextField(12); formPanel.add(tfNom, g);

        g.gridx=0; g.gridy=2; formPanel.add(new JLabel("Salaire (€) :"), g);
        g.gridx=1; tfSalaire = new JTextField(8); formPanel.add(tfSalaire, g);
        g.gridx=2; formPanel.add(new JLabel("Info extra :"), g);
        g.gridx=3; tfExtra = new JTextField(14); formPanel.add(tfExtra, g);
        ...
        btnRow.add(btnAjouter); btnRow.add(btnPrime); btnRow.add(btnSupprimer);
    ...
    private void refreshTable() {
        ...
        for (Employe emp : gestionEmploye.getListeEmployes()) {
            tableModel.addRow(new Object[]{
                    ...
                    emp.getRole(), String.format("%.2f", emp.getSalaire())
            });
        }
    }
        ...
        try {
            ...
            switch (role) {
                ...
                case "Comptable":
                    ...
                    break;
                default:
                    emp = new Magasinier(mat, nom, pr, sal, extra.isEmpty() ? "Entrepôt A" : extra);
            }
    ...
    private void supprimerEmploye() {
        ...
        if (row < 0) { JOptionPane.showMessageDialog(this, "Sélectionnez un employé.", "Info", JOptionPane.WARNING_MESSAGE); return; }
    ...
    private void ajouterPrime() {
        ...
        if (row < 0) { JOptionPane.showMessageDialog(this, "Sélectionnez un employé.", "Info", JOptionPane.WARNING_MESSAGE); return; }
        int mat = (int) tableModel.getValueAt(row, 0);
        String input = JOptionPane.showInputDialog(this, "Montant de la prime (€) :", "Ajouter prime", JOptionPane.QUESTION_MESSAGE);
    ...
    private void viderFormulaire() {
        tfMatricule.setText(""); tfNom.setText(""); tfPrenom.setText("");
        tfSalaire.setText(""); tfExtra.setText("");
    }
