...
public class Caissier extends Employe {
	...
	public void effectuerVente(int pNumeroVente, Client pClient, ArrayList<Produit> pPanier) {
		...
		venteEnCours = new Vente(pNumeroVente, new Date(), pClient, this);
		if (pPanier != null) {
	...
	public Paiement encaisserPaiement(int pNumeroPaiement, String pModePaiement) {
		...
		Paiement paiement = new Paiement(pNumeroPaiement, montant, pModePaiement, new Date(), venteEnCours);
