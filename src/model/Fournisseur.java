...
public class Fournisseur {
    ...
    public void ajouterProduit(Produit produit, int pQuantiteAFournir) {
        if (pQuantiteAFournir > 0) {
            ...
            System.out.println("Fournisseur [" + nom + "] a livré " + pQuantiteAFournir
    ...
    public void afficher() {
        System.out.println("Fournisseur [Code: " + code + " | Nom: " + nom
                + " | Tél: " + telephone + " | Adresse: " + adresse + "]");
    }
    ...
    public ArrayList<Produit> getProduitsFournis(){ return produitsFournis; }
