...
public class Magasinier extends Employe {
    ...
    // Attributs
    private String zoneStockage; // ex: "Entrepôt A", "Réserve B"

    // Constructeur d'initialisation
    public Magasinier(int pMatricule, String pNom, String pPrenom, double pSalaire, String pZoneStockage) {
        super(pMatricule, pNom, pPrenom, pSalaire);
        setRole("Magasinier");
        zoneStockage = pZoneStockage;
    }
    ...
    public void receptionnerLivraison(CommandeFournisseur commande) {
        System.out.println("=== Réception de la commande n°" + commande.getNumeroCommande()
                + " du fournisseur : " + commande.getFournisseur().getNom() + " ===");
    ...
    public void mettreAJourStock(Produit produit, int quantite, boolean estEntree) {
        if (estEntree) {
            ...
            System.out.println("Stock mis à jour (+) : " + produit.getDesignation()
    ...
    // Getters
    public String getZoneStockage() { return zoneStockage; }

    // Setters
    public void setZoneStockage(String zoneStockage) { this.zoneStockage = zoneStockage; }
}
