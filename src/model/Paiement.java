...
public class Paiement {
	...
	public static final String carte = "Carte bancaire";
	...
	public Paiement(int pNumeroPaiement, double pMontant, String pModePaiement, Date pDatePaiement, Vente pVente) {
	...
	public boolean validerPaiement() {
		...
		if (montant < totalVente) {
			System.out.println(
					"Paiement insuffisant : " + montant + " € pour " + String.format("%.2f", totalVente) + " €");
			valide = false;
			return false;
		}
		...
		valide = true;
		System.out.println(
				"Paiement validé (" + modePaiement + "). Monnaie rendue : " + String.format("%.2f", rendu) + " €");
		return true;
	}

	// Calcul de la monnaie à rendre car il peut arriver que le montant payer peu depasser ce qu'il fallait
	...
	public void afficherPaiement() {
		System.out.println("Paiement n°" + numeroPaiement + " | Mode: " + modePaiement + " | Montant: "
				+ String.format("%.2f", montant) + " €" + " | Date: " + datePaiement + " | État: "
